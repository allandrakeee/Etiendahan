<?php   
    ...
    if($mime_type != 'image') {
        ...
        $sql = "INSERT INTO tbl_products (id, name, description, sub_id, price, stock, image, created_at, seller_email, banned) VALUES (null, '$name','$description', '$sub_id', '$price', '$stock', '$db_path', NOW(), '$email', 0)";
