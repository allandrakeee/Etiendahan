						...
						<div class="row">
							<div class="col-md-3" style="padding-right: 0">
								<div class="sidebar-wrapper">
									...
									<div class="title active"><a href="/etiendahan/category/view/">All Locations</a></div>									
									...
									<div class="sub">
										<ul>
											...
											?>
											<li><a href="/etiendahan/location/view/sub/" class="my-gallery-inner" id="<?php echo $row_category_sub['id'] ?>"><?php echo ucwords($category_name) ?> (<?php
