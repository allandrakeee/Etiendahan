									...
									?>
										<div class="row mb-1">
											...
											<div class="col-md-2 text-right">
												<a class="address-fa address-update" style="cursor: pointer;" data-toggle="modal" data-target="#modifyModal-<?php echo $address_row['id'] ?>" id="<?php echo $address_row['id'] ?>"><i class="fa fa-edit"></i></a>
												...
												<div class="modal fade modify" id="modifyModal-<?php echo $address_row['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="modifyModalLabel-<?php echo $address_row['id'] ?>" aria-hidden="true">
													<div class="modal-dialog" role="document">
														<div class="modal-content">
															...
															<div class="modal-body">
																<div class="container-fluid">
																	<form id="submitAddAddress" action="/etiendahan/c8NLPYLt-functions/address-function/" method="POST">												
																		...
																		<div class="form-group row">
																			<div class="col-sm-12">
																				<input type="text" class="form-control" id="inputFullnameAddAddress" placeholder="Fullname" name="fullname" value="<?php echo $address_row['fullname']; ?>" required autofocus>
																			</div>
																		</div>
																		...
																		<div class="form-group row">
																			<div class="col-sm-12">
																				<input type="number" class="form-control" id="inputPhoneNumberAddAddress" name="phone_number" placeholder="Phone Number" value="<?php echo $address_row['phone_number']; ?>" required>
																			</div>
																		</div>
																		...
																		<div class="form-group row">
																			<div class="col-sm-12">
																				<input type="number" class="form-control" id="inputPostalCodeAddAddress" name="postal_code" placeholder="Postal Code" value="<?php echo $address_row['postal_code']; ?>" required>
																			</div>
																		</div>
																		...
																		<div class="form-group row">
																			<div class="col-sm-12">
																				<input type="text" class="form-control" id="inputCompleteAddressAddAddress" name="complete_address" placeholder="Complete Address (House Number, Building and Street Name)" value="<?php echo $address_row['complete_address']; ?>" required>
																			</div>
																		</div>
																		...
																		<div class="form-group row">
																			<div class="col-sm-12">
																				<input type="text" class="form-control" id="inputOtherNotesAddAddress" name="other_notes" placeholder="Other notes" value="<?php echo $address_row['other_notes']; ?>" required>
																			</div>
																		</div>
																		<input type="hidden" name="id" id="id">
																	</form>
															...
															<div class="modal-footer">
																<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
																<button type="submit" onclick="modifyAddress(<?php echo $address_row['id'] ?>)" class="btn btn-primary-save">Save</button>
															</div>
														</div>
													</div>
												</div>
