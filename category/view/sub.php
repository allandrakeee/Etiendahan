<?php  
	...
	$result_sub_category = $mysqli->query("SELECT * FROM tbl_categories_sub WHERE id = '$category_id'");
							...
							<div class="col-md-9">
								...
								<div class="item-wrapper" id="item-wrapper-grid-list">
									<?php  
										...
										$product_result = $mysqli->query("SELECT * FROM tbl_products WHERE sub_id = '$sub_category_id' AND stock != 0 AND banned = 0 ORDER BY RAND()");
