...
<html>
<head>
	<title>Your Recently Viewed Products | Etiendahan Dagupan</title>
	<meta charset="utf-8">
								...
								<div id="etiendahan-section-5" class="etiendahan-section">
									<div class="container">
										<div class="title-name">
											<h3><span class="wow pulse" data-wow-delay="1000ms">YOUR RECENTLY VIEWED PRODUCTS</span></h3>
										</div>
										...
										<div class="item-wrapper">
											...
											?>
												<div>No Recently Viewed Products Yet</div>
											<?php else: ?>
												<div class="clear-history-product" style="position: absolute; right: 30px; top: 65px;"><a href="/etiendahan/recently-viewed-products/clear/" style="text-decoration: none;">Clear Product History</a></div>
												<?php  
													...
													$product_result = $mysqli->query("SELECT * FROM tbl_products WHERE id IN($product_id) AND stock > 0 AND banned = 0");
													while($product_row = mysqli_fetch_assoc($product_result)):
												?>
													<div class="item">
													<?php 
														$product_id_date = $product_row['id'];
