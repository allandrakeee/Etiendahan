        ...
        <nav class="navbar-default navbar-side" role="navigation" style="height: 570px;overflow: hidden;overflow-y: scroll;">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    ?>
                    <li>
                        <a href="/etiendahan/ed-admin/restricted/customers/" class="active-menu waves-effect waves-dark"><i class="material-icons dp48" style="display: inline-block;font-size: 15px;">supervisor_account</i> Customers (<?php if($product_count[0] == 0): ?>0<?php else: ?><?php echo number_format((int)$product_count[0], 0, '', ','); endif; ?>)</a>
                    </li>
                    <?php  
        ...
        <div id="page-wrapper">
          <div class="header"> 
            ...
            <div id="page-inner" class="table-responsive">
                <?php $customers_result = $mysqli->query("SELECT * FROM tbl_customers WHERE banned = 0"); ?>
                ...
                <?php else: ?>
                    <table class="table">
                      ...
                      <tbody>
                        <?php  
                            $customers_result = $mysqli->query("SELECT * FROM tbl_customers WHERE banned = 0");
