        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    ?>    
                    <li>
                        <a href="/etiendahan/ed-admin/restricted/banned-products/" class="active-menu waves-effect waves-dark"><i class="material-icons dp48" style="display: inline-block;font-size: 15px;">pan_tool</i> Banned Products (<?php if($product_count[0] == 0): ?>0<?php else: ?><?php echo number_format((int)$product_count[0], 0, '', ','); endif; ?>)</a>
                    </li>
        ...
        <div id="page-wrapper">
          <div class="header"> 
            ...
            <div id="page-inner" class="table-responsive">
                <?php $product_result = $mysqli->query("SELECT * FROM tbl_products WHERE banned = 1"); ?>
                ...
                <?php else: ?>
                    <table class="table">
                      ...
                      <tbody>
                        <?php  
                            $product_result = $mysqli->query("SELECT * FROM tbl_products WHERE banned = 1");
                            while($product_row = mysqli_fetch_assoc($product_result)):
                        ?>
                            <tr>
                              ...
                              <td><a href="/etiendahan/ed-admin/restricted/banned-products/unbanned/" class="action-banned-customer" id="<?php echo $product_row['id'] ?>" style="color: dimgrey;"><i class="material-icons dp48" style="display: inline-block;font-size: 15px;">pan_tool</i></a></td>
                            </tr>
                        <?php endwhile; ?>
                      </tbody>
                    </table>
