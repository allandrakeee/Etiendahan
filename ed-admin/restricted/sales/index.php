        ...
        <nav class="navbar-default navbar-side" role="navigation" style="height: 570px;overflow: hidden;overflow-y: scroll;">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <!-- sales -->
                    <li>
                        <a href="/etiendahan/ed-admin/restricted/sales/" class="active-menu waves-effect waves-dark"><i class="material-icons dp48" style="display: inline-block;font-size: 15px;">import_export</i> Sales</a>
                    </li>
                ...
                <?php else: ?>
                    <table class="table">
                      ...
                      <tbody>
                            ...
                            ?>
                            <tr>
                              <td style=""><?php echo ($product_order_row['total_quantity'] == '')?'0':$product_order_row['total_quantity']; ?></td>
                            </tr>
                      </tbody>
                    </table>
                <?php endif; ?>
