        ...
        <div id="page-wrapper">
          <div class="header"> 
            ...
            <div id="page-inner">
                ...
                <form action="/etiendahan/c8NLPYLt-functions/modify-slides-function/" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="title"><strong>Title:</strong></label>
                        <input type="text" class="form-control" id="title" maxlength="115" name="title" value="<?php echo $slides_row['title'] ?>" required autofocus>
                    </div>
                    ...
                    <a href="/etiendahan/ed-admin/restricted/slides/" class="pull-right" style="text-decoration: none; position: absolute;right: 118px;margin-top: 9px">Cancel</a><button type="submit" class="btn btn-default pull-right" name="submit_slides">Save</button>
                </form>
                <img src="<?php echo $slides_row['image'] ?>" alt="" style="height: 100px">
            <!-- /. PAGE INNER  -->
            </div>
        <!-- /. PAGE WRAPPER  -->
    </div>
