        ...
        <nav class="navbar-default navbar-side" role="navigation" style="height: 570px;overflow: hidden;overflow-y: scroll;">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    ?>
                    <li>
                        <a href="/etiendahan/ed-admin/restricted/banned-customers/" class="active-menu waves-effect waves-dark"><i class="material-icons dp48" style="display: inline-block;font-size: 15px;">pan_tool</i> Banned Customers (<?php if($product_count[0] == 0): ?>0<?php else: ?><?php echo number_format((int)$product_count[0], 0, '', ','); endif; ?>)</a>
                    </li>  
        ...
        <div id="page-wrapper">
          <div class="header"> 
            ...
            <div id="page-inner" class="table-responsive">
                <?php $customers_result = $mysqli->query("SELECT * FROM tbl_customers WHERE banned = 1"); ?>
                ...
                <?php else: ?>
                    <table class="table">
                      ...
                      <tbody>
                        <?php  
                            $customers_result = $mysqli->query("SELECT * FROM tbl_customers WHERE banned = 1");
                        ...
                        ?>
                            <tr>
                              ...
                              <!-- <td style=""></td> -->
                              <td><a href="/etiendahan/ed-admin/restricted/banned-customers/unbanned/" class="action-banned-customer" id="<?php echo $customers_row['id'] ?>" style="color: dimgrey;"><i class="material-icons dp48" style="display: inline-block;font-size: 15px;">pan_tool</i></a></td>
                            </tr>
                        <?php endwhile; ?>
                      </tbody>
                    </table>
