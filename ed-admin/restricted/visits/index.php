        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    ?>
                    <li>
                        <a href="/etiendahan/ed-admin/restricted/visits/" class="active-menu waves-effect waves-dark"><i class="material-icons dp48" style="display: inline-block;font-size: 15px;">equalizer</i> Visits (<?php if($visit_row[0] == 0): ?>0<?php else: ?><?php echo number_format((int)$visit_row[0], 0, '', ','); endif; ?>)</a>
                    </li>
                </ul>
            </div>
        </nav>
                    ...
                    <table class="table">
                      <thead>
                        <tr>
                          ...
                          <th scope="col">Unregistered Customer</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php  
                            $visit_result_registered = $mysqli->query("SELECT COUNT(*) FROM tbl_visits WHERE registered_customer = 1");
                            $visit_row_registered = $visit_result_registered->fetch_row();

                            $visit_result_unregistered = $mysqli->query("SELECT COUNT(*) FROM tbl_visits WHERE registered_customer = 0");
                            $visit_row_unregistered = $visit_result_unregistered->fetch_row();
                        ?>
                            <tr>
                              <td style=""><?php echo $visit_row_registered[0]; ?></td>
                              <td style=""><?php echo $visit_row_unregistered[0]; ?></td>
                            </tr>
                      </tbody>
                    </table>
                <?php endif; ?>
