       ...
       <!--/. NAV TOP  -->
        ...
        <div id="page-wrapper">
          <div class="header"> 
            ...
            <div id="page-inner">
                <?php  
       	 			$modify_product_sic_result = $mysqli->query("SELECT * FROM tbl_sic_product WHERE id = '$sic_id'");
					$modify_product_sic_row = $modify_product_sic_result->fetch_assoc();
                ?>
                <form action="/etiendahan/c8NLPYLt-functions/modify-product-function/" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <div class="input-field">
                            <input type="text" class="validate" style="margin-bottom: 8px;" id="product_name" maxlength="115" name="product_name" value="<?php echo $modify_product_sic_row['name']; ?>" required>
                    ...
                    <div class="form-group">
                        <div class="input-field">
                            <input type="text" class="validate" style="margin-bottom: 8px;" id="product_description" maxlength="115" name="product_description" value="<?php echo $modify_product_sic_row['description']; ?>">
                    ...
                    <div class="form-group">
                        <div class="input-field money">
                            <input type="text" class="validate numberOnly" style="margin-bottom: 8px;" autocomplete="off" id="product_price" name="product_price" value="<?php echo $modify_product_sic_row['price']; ?>"  required><div></div>
                    ...
                    <div class="form-group" style="width: 25%">
                        ...
                        <select class="browser-default" name="sic_owner" required>
                            ...
                            ?>
                            	<?php if($sic_owner_row['id'] == $modify_product_sic_row['owner_id']): ?>
					...
					<img src="<?php echo $modify_product_sic_row['image'] ?>" style="height: 100px;" alt="">
    ...
    <div id="popup-notification-welcome" class="wow fadeIn">
        ...
        <div class="popup-content-welcome text-center" style="font-size: 14px;">
            <?php  
                ...
                // Display message only once
                if ( isset($_SESSION['modify-product']) ) {
                    echo $_SESSION['modify-product'];
                    // Don't annoy the user with more messages upon page refresh
                    unset($_SESSION['modify-product']);
                }
            ?>
        </div>
    </div>
