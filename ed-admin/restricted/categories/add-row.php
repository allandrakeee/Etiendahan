          ...
          <div class="header"> 
            <h1 class="page-header">
                ...
                <ol class="breadcrumb" style="margin-left: 0; padding-left: 0;">
                  ...
                  <li><a href="/etiendahan/ed-admin/restricted/categories/modify/">Modify</a></li>
                  <li class="active">Add Row</li>
                </ol> 
            </h1>           
        </div>
            ...
            <div id="page-inner">
                ...
                <form action="/etiendahan/c8NLPYLt-functions/add-row-categories-function/" method="POST" enctype="multipart/form-data" style="margin-bottom: 80px;">                  
                    <div class="form-group dynamic" style="width: 475px; margin-bottom: 8px">
                        <label for="sub_category">Add Sub Categories for <strong><?php echo $categories_row['name']; ?></strong>:</label>
                        <input type="text" class="form-control" id="sub_category" name="sub_category[]" value="" required autofocus>                        
                    </div>
                    <a type="button" id="btnAdd" style="text-decoration: none; cursor: pointer;"><i class="fa fa-plus"></i> Add Row</a>
                    <a href="/etiendahan/ed-admin/restricted/categories/modify/" class="pull-right" style="text-decoration: none; position: absolute;right: 118px;margin-top: 9px">Cancel</a><button type="submit" class="btn btn-default pull-right" name="submit_categories">Save</button>
                </form>
            <!-- /. PAGE INNER  -->
            </div>
        <!-- /. PAGE WRAPPER  -->
    ...
    <div id="popup-notification-welcome" class="wow fadeIn">
        ...
        <div class="popup-content-welcome text-center" style="font-size: 14px;">
            <?php  
                ...
                if ( isset($_SESSION['add-sub-category']) ) {
                    echo $_SESSION['add-sub-category'];
                    // Don't annoy the user with more messages upon page refresh
                    unset($_SESSION['add-sub-category']);
                }
            ?>
        </div>
    </div>
