								...
								<div id="etiendahan-section-5" class="etiendahan-section">
									<div class="container">
										...
										<div class="item-wrapper">
											...
											?>
												<div>No Popular Products Yet</div>
											<?php else: ?>
												<?php  
													$recently_viewed_products_result = $mysqli->query("SELECT GROUP_CONCAT(product_id) as 'product_id_result' FROM tbl_orders");
													...
													while($product_row = mysqli_fetch_assoc($product_result_recently_viewed_products)):
												?>
													<div class="item">
													<?php 
