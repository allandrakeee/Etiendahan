			...
			<div class="main">
				...
				<ul class="nav justify-content-center text-center">
					...
					<li class="nav-item active">
						<a class="nav-link active" href="/etiendahan/seller-centre/product/list/banned/">Banned</a>
					</li>
				</ul>
				...
				<div class="container inner">
					<div class="row">
						<div class="col-md-12">
							<div class="products-number">
								<?php  
									$result_product_count = $mysqli->query("SELECT COUNT(*) FROM tbl_products WHERE seller_email = '$email' and banned = 1");
					...
					<div class="row">
						<?php  
							$result_product = $mysqli->query("SELECT * FROM tbl_products WHERE seller_email = '$email' and banned = 1 GROUP BY name");
