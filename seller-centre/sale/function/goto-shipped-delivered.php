<?php  
	...
	$orders_unique_hash = $mysqli->query("SELECT * FROM tbl_orders WHERE unique_hash_id = '$unique_hash_id' AND status = 'delivered'");
	...
	header('location: /etiendahan/seller-centre/sale/list/delivered/');
?>