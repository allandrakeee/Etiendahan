					...
					<div class="row">
						<div class="col-md-12" id="page-inner">
							<table class="table" id="delivered">
								...
								<tbody>
									<?php  
										$orders_product_id_result = $mysqli->query("SELECT * FROM tbl_orders WHERE status = 'delivered'");
									...
									?>
												<tr>
													...
													<td><a href="/etiendahan/seller-centre/sale/function/goto-shipped-delivered/" class="goto-sales" id="<?php echo $orders_product_id_row['id'] ?>"><i class="fa fa-angle-left" style="font-size: 20px; color: dimgrey;"></i></a></td>
												</tr>
