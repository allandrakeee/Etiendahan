...
<!-- 					<li class="nav-item">
 ...
 -->					<li class="nav-item">
					...
					<li class="nav-item active">
						<a class="nav-link active" href="/etiendahan/seller-centre/sale/list/delivered/">Delivered</a>
					</li>
				</ul>
									...
									?>
												<tr>
													...
													<td>
														<?php  
															$count = 1;
															$product_orders = $mysqli->query("SELECT * FROM tbl_orders WHERE unique_hash_id = '$unique_hash_id' AND status = 'delivered'");
													...
													<!-- action -->
													<td><a href="/etiendahan/seller-centre/sale/function/goto-shipped-delivered/" class="goto-sales" id="<?php echo $orders_product_id_row['unique_hash_id']; ?>"><i class="fa fa-angle-left" style="font-size: 20px; color: dimgrey;"></i></a></td>
												</tr>
									<?php endwhile; ?>
								</tbody>
							</table>
